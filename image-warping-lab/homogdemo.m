...
[x2, y2] = ginput(4);
leftpts2 = [x2'; y2'];
out = zeros(size(leftpts2));

pointSize = size(leftpts2, 2);

for i = 1: pointSize
    matrix = H * [leftpts2(1, i) ; leftpts2(2, i) ; 1];
    out = [out [(matrix(1) / matrix(3)) ; matrix(2) / matrix(3)] ];
end

figure(1)
plot(leftpts2(1,:), leftpts2(2,:), 'mx');
