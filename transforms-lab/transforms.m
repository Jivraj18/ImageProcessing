...
T_e = [cos(pi/4) -sin(pi/4) 4; sin(pi/4) cos(pi/4) 20; 0 0 2];

% (f) Anisotropic scale + rotation + translation.
T_f = [0.8*cos(-3*pi/4) 1.6*-sin(-3*pi/4) 8; 0.8*sin(-3*pi/4) 1.6*cos(-3*pi/4) 28; 0 0 2];

% (g) Fully affine.
T_g = [1.9*cos(-pi/8) 2.1*-sin(-pi/8) 16; -1.95*sin(-pi/8) 1.99*cos(-pi/8) 16; 0 0 2];

% (h) Perspective.
T_h = [cos(-pi/8) -sin(-pi/8) 20; 0.5*sin(-pi/8) 1.1*cos(-pi/8) 11; 0 0 2];
